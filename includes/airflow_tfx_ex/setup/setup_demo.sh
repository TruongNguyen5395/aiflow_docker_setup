...
# Copy Dag to ~/airflow/ex-dag
mkdir -p ~/airflow/ex-dag
cp ex-dag/taxi_pipeline.py ~/airflow/ex-dag/
cp ex-dag/taxi_utils.py ~/airflow/ex-dag/

# Copy the simple pipeline example and adjust for user's environment
cp ../../chicago_taxi_pipeline/taxi_pipeline_simple.py ~/airflow/ex-dag/taxi_pipeline_solution.py
cp ../../chicago_taxi_pipeline/taxi_utils.py ~/airflow/ex-dag/taxi_utils_solution.py
sed -i'.orig' "s/os.environ\['HOME'\], 'taxi'/os.environ\['HOME'\], 'airflow'/g" ~/airflow/ex-dag/taxi_pipeline_solution.py
sed -i'.orig' "s/_taxi_root, 'data', 'simple'/_taxi_root, 'data', 'taxi_data'/g" ~/airflow/ex-dag/taxi_pipeline_solution.py
sed -i'.orig' "s/taxi_utils.py/dags\/taxi_utils_solution.py/g" ~/airflow/ex-dag/taxi_pipeline_solution.py
sed -i'.orig' "s/os.environ\['HOME'\], 'tfx'/_taxi_root, 'tfx'/g" ~/airflow/ex-dag/taxi_pipeline_solution.py
sed -i'.orig' "s/chicago_taxi_simple/taxi_solution/g" ~/airflow/ex-dag/taxi_pipeline_solution.py
